...
**남은 것**:
- **파일럿 실행** — `/app` 무대 녹화 영상 6편 + 설문지 방식 (전용 /demo 화면은 08-19 삭제 — 참가자별 재생 편차가 없어 통제가 오히려 좋다). 코드 6편·녹화 규격은 pilot-guide에 내장
...
| 08-19 | **/demo 삭제, 파일럿은 녹화 영상 + 설문지로** — 전용 화면·픽스처·생성 스크립트 제거, 코드 6편은 pilot-guide에 내장 | 네비 미연결 화면의 유지비 제거 + 녹화가 참가자별 재생 편차를 없애 실험 통제에 유리 |
