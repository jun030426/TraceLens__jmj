...
| 08-18 | **은유 스킨 = 유일한 베이스** — 막대·저울·스핀·스윕, 색 4역할, 정밀 모드 삭제 | `specs/2026-08-18-intro-metaphor-skin-design.md` ← **현재 방향** |

## specs — 살아있는 문서

| 문서 | 성격 | 상태 |
|---|---|---|
| `2026-08-11-algo-scope-design.md` | 기획 동결본 (팀 계약) | 유효 — 단 렌더 표현은 이후 문서들이 개정 |
| `2026-08-11-algo-scope-glossary.md` | 용어 해설 | 유효 |
| `2026-08-11-pilot-guide.md` | 파일럿 진행 가이드 | 유효 — 08-18 갱신 절 필독 (끈→이름표, 저울, 길이 재실측) |
| `2026-08-18-learner-flow-film-design.md` | 학습자 흐름 진단·원칙 | 유효 |
| `2026-08-18-intro-metaphor-skin-design.md` | 은유 스킨 설계 + 개정 | **현재 방향의 기준 문서** |
